...
const TradeDocumentStatus: React.FC<TradeDocumentStatusProps> = ({ 
  ...
  useEffect(() => {
    if (selectedTrade && detailsRef.current) {
  ...
  return (
    <div className="space-y-6">
      ...
      {selectedTrade && (
        <div ref={detailsRef} className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg shadow-lg border border-blue-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Complete document status and workflow information</p>
              </div>
            </div>
            <button
          ...
          <div className="mb-6 p-6 bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-900 font-semibold">{selectedTrade.tradeId}</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-gray-600 font-medium">Type:</span> 
                <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                  'orderId' in selectedTrade ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'
                }`}>
                  {'orderId' in selectedTrade ? 'Equity' : 'FX'}
                </span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-gray-600 font-medium">Counterparty:</span> 
                <span className="text-gray-900">{selectedTrade.counterparty}</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-gray-600 font-medium">Trade Date:</span> 
                <span className="text-gray-900">{selectedTrade.tradeDate}</span>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-gray-600 font-medium">Queue Status:</span> 
                <span className="text-gray-900">{selectedTrade.queueStatus || 'N/A'}</span>
              </div>
            </div>
          </div>
